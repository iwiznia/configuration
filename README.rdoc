...
== Description {<img src="https://secure.travis-ci.org/iwiznia/configuration.png" />}[http://travis-ci.org/iwiznia/configuration]
...
allow to override an entire scope, skipping inheritance
  ...
  p c.thing #=> 3
  p c.some  #=> Configuration::Error: Config some not defined!
